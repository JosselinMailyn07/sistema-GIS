...
const auditoria = [
  { empresa: '1', usuario: 'sa', fechayhora: '2023-10-01 12:00', gestion: 'CFG', opcion: 'Auditoría', operacion: 'ELI', documento: '', sesion: ''  },
  { empresa: '2', usuario: 'sa', fechayhora: '2023-10-02 14:30', gestion: 'CFG', opcion: 'Salió de Configuración', operacion: 'CER', documento: '', sesion: '' },
  { empresa: '3', usuario: 'ji', fechayhora: '2023-10-03 09:15', gestion: 'CFG', opcion: 'Salió del Sistema', operacion: 'ENT', documento: '', sesion: '00001797' },
