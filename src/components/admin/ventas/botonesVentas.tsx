...
import { Modal } from '../ventas/modalVentas';

interface BotonesProps {
  titulo: string;
  onSearch: (searchTerm: string) => void;
  formularioNuevo?: React.ReactNode; // Función para manejar la búsqueda
}

export const botones = ({ titulo = "", onSearch, formularioNuevo }: BotonesProps) => {
      ...
      <div className="flex space-x-2">
        ...
        {mostrarModal && (
          <Modal onClose={() => setMostrarModal(false)}>
            {formularioNuevo /* Aquí se muestra el formulario pasado como prop */}
          </Modal>
        )}
      </div>
    </div>
